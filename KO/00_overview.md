...
| 주제 | 문서 |
|------|------|
| 에이전트 전체 구조와 실행 루프 | [04_agent_system/01_agent_architecture.md](04_agent_system/01_agent_architecture.md) |
...
| Query Planner 상세 | [04_agent_system/02_query_planner.md](04_agent_system/02_query_planner.md) |
| Graph Retriever 상세 | [04_agent_system/03_graph_retriever.md](04_agent_system/03_graph_retriever.md) |
| Evidence Retriever 상세 | [04_agent_system/04_evidence_retriever.md](04_agent_system/04_evidence_retriever.md) |
| Causal Reasoner 상세 | [04_agent_system/05_causal_reasoner.md](04_agent_system/05_causal_reasoner.md) |
| Risk Controller / Answer Composer 상세 | [04_agent_system/06_risk_controller_and_answer_composer.md](04_agent_system/06_risk_controller_and_answer_composer.md) |
