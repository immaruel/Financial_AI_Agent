...
const TRANSLATIONS = {
  ko: {
    ...
    'trust2-desc': '금융 데이터의 성격이 다른만큼 3계층으로 분리 — 독립 업데이트 · Multi-hop 탐색 최적화 · 출처 역추적으로 할루시네이션 방지',
    ...
    'hier3-freq': '원문 역추적',
    'kgh-eff1': '계층별로 탐색 범위를 좁혀 Multi-hop 경로 명확화',
    'kgh-eff2': '이벤트 추가가 정적 구조에 영향 없음 — 레이어별 독립 업데이트',
    'kgh-eff3': '모든 이벤트 주장에 원문 역추적 — 할루시네이션 구조적 방지',
  ...
  en: {
    ...
    'trust2-desc': 'Financial data has different natures — 3-layer separation for independent updates · optimized Multi-hop traversal · hallucination prevention via source tracing',
    'hier1-name': 'Static Nodes',
    ...
    'kgh-eff1': 'Narrows traversal scope per layer — Multi-hop paths become explicit',
    'kgh-eff2': 'New events do not affect static structure — layers update independently',
    'kgh-eff3': 'Every event claim traces back to original source — hallucination prevention by design',
