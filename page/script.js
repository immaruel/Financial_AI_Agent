...
const TRANSLATIONS = {
  ko: {
    ...
    'tier5-label': '루머 (5등급)',
    'tier5-note': '필터 대상',
    'trust2-title': '온톨로지 기반 계층적 지식 그래프',
    'trust2-desc': '금융 데이터는 성격이 다르다 — 3계층으로 분리해 독립 업데이트 · 출처 역추적 구현',
    'hier1-name': 'Static Nodes',
    'hier1-freq': '수년간 안정',
    'hier1-desc': '기업 · 산업 · 기관 — 잘 바뀌지 않는 사실 레이어. "자동차 산업" 질의 시 현대차 · 기아 · 모비스를 한번에 묶어 탐색',
    'hier-conn1': '참조',
    'hier2-name': 'Event Nodes',
    'hier2-freq': '매일 갱신',
    'hier2-desc': '14유형 금융 이벤트 — FIBO 온톨로지 기반 설계. 유가 상승 → 영향 → 원유 수입 기업 비용 흐름으로 구성',
    'hier-conn2': '뒷받침',
    'hier3-name': 'Evidence Nodes',
    'hier3-freq': '원문 역추적',
    'hier3-desc': '이벤트를 뒷받침하는 공시 · 뉴스 원문 문장. 모든 주장에 근거 역추적 → 할루시네이션 구조적 방지',
    'hier-qf-label': 'QUERY FLOW',
    'hier-qf1': 'L1: 현대차 노드',
    'hier-qf2': 'L2: 계약 이벤트',
    'hier-qf3': 'L3: 공시 원문',
  ...
  en: {
    ...
    'trust2-title': 'Ontology-based Hierarchical Knowledge Graph',
    'trust2-desc': 'Financial data has different natures — separated into 3 layers for independent updates & source traceability',
    'hier1-name': 'Static Nodes',
    'hier1-freq': 'Stable for years',
    'hier1-desc': 'Company · Industry · Institution — rarely changing facts. Querying "auto industry" groups Hyundai, Kia, Mobis together in one hop',
    'hier-conn1': 'references',
    'hier2-name': 'Event Nodes',
    'hier2-freq': 'Daily updates',
    'hier2-desc': '14-type financial events — designed on FIBO ontology. Graphs flows like: oil price rise → impacts → import company raw material costs',
    'hier-conn2': 'supported by',
    'hier3-name': 'Evidence Nodes',
    'hier3-freq': 'Source tracing',
    'hier3-desc': 'Original sentences from filings & news backing each event. Every claim is traceable to source → hallucination prevention by design',
    'hier-qf-label': 'QUERY FLOW',
    'hier-qf1': 'L1: Hyundai node',
    'hier-qf2': 'L2: Contract event',
    'hier-qf3': 'L3: DART filing',
