...
const TRANSLATIONS = {
  ko: {
    ...
    'wall-s1-title': '온톨로지 기반 Hierarchical KG',
    'wall-s1-desc': 'FIBO 기반 3계층 설계로 기업·이벤트·출처 관계를 구조적으로 인코딩',
    'wall-s2-title': 'Sub-graph Retrieval',
    'wall-s2-desc': '관련 노드만 정밀 추출하여 다단계 탐색',
    'wall-s3-title': '실시간 수집 · 최신 상태 갱신',
    'wall-s3-desc': '공시·뉴스를 자동 수집해 L2/L3 노드를 상시 업데이트, 노이즈 없는 최신 근거 제공',
    'wall-s4-title': 'F1~F8 Taxonomy + Trace',
    'wall-s4-desc': '8가지 실패 유형 분류와 단계별 Trace 수집',
    'wall-s5-title': 'Risk Controller 레이어',
    'wall-s5-desc': '투자 권유, 단정적 표현을 자동 감지 및 필터링',
  ...
  en: {
    ...
    'wall-s1-title': 'Ontology-based Hierarchical KG',
    'wall-s1-desc': 'FIBO-based 3-layer design encodes company·event·source relationships structurally',
    'wall-s2-title': 'Sub-graph Retrieval',
    'wall-s2-desc': 'Precisely extract only relevant nodes for multi-hop traversal',
    'wall-s3-title': 'Real-time Collection · State Updates',
    'wall-s3-desc': 'Auto-ingest filings & news to keep L2/L3 nodes current — noise-free, up-to-date evidence',
    'wall-s4-title': 'F1–F8 Taxonomy + Trace',
