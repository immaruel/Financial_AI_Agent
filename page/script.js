...
const TRANSLATIONS = {
  ko: {
    ...
    'tier5-label': '루머 (5등급)',
    'tier5-note': '필터 대상',
    'trust2-title': 'Entity Resolution 캐스케이드',
    'trust2-desc': '"현대자동차"와 "현대차"를 같은 엔티티로 해소합니다',
    'resolve1-input': '"현대자동차"',
    'resolve1-method': 'Reference 사전 매칭',
    'resolve2-input': '"현대차"',
    'resolve3-method': 'Rule 기반 정규화',
    'resolve4-input': '미분류 mention',
    'resolve4-method': 'LLM 최종 판단',
  ...
  en: {
    ...
    'trust2-title': 'Entity Resolution Cascade',
    'trust2-desc': 'Resolves "Hyundai Motor" and "HMC" as the same entity',
    'resolve1-input': '"Hyundai Motor"',
    'resolve1-method': 'Reference Dictionary Match',
    'resolve2-input': '"Hyundai"',
    'resolve3-method': 'Rule-based Normalization',
    'resolve4-input': 'Unclassified mention',
    'resolve4-method': 'LLM Final Decision',
